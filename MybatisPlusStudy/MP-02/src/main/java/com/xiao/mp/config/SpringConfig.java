...
public class SpringConfig {
    ...
    public SqlSessionFactory createMybatisSqlSessionFactoryBean(DataSource dataSource, GlobalConfig globalConfig, MybatisConfiguration configuration) throws Exception {
